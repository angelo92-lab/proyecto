...
@if ($alumno)
    <div class="card p-4 mb-4 shadow-sm">
        ...
        <p><strong>Dirección:</strong> {{ $alumno->Dirección }}</p> <!-- Asegúrate que este nombre coincida -->
        <p><strong>Comuna Residencia:</strong> {{ $alumno->{'Comuna Residencia'} }}</p> <!-- Cambiado a usar llaves para evitar el error -->
